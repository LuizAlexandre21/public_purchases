...
class TCE_data:
    ...
    # Definindo a função construtora de dataframe 
    ...
    def data(self):
        ...
        for doc in Links:
            ...
            item_1.append(items)
            item_2.append(licitacao)

        # Concatenando os dataframes
        # Items 
        item = pd.concat(item_1)

        # Licitação 
        licitacao = pd.concat(item_2)

        return item, licitacao
        ...
        for arch in lista:
            ...
            match arch.filename: 
                ...
                case 'licitacao.csv': 
                    ...
                    # Salvando os arquivos 
                    licitação = pd.read_csv('licitacao.csv')
